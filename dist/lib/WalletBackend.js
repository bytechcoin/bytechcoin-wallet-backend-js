...
class WalletBackend extends events_1.EventEmitter {
     ...
     * as bytech-service or zedwallet, and will be unable to open wallets
     ...
     * Usage:
     * ```
     * const daemon = new ConventionalDaemon('127.0.0.1', 11127);
     *
     ...
     * Usage:
     * ```
     * const [publicSpendKey, privateSpendKey, error] = getSpendKeys('bYTCxyz...');
     * if (error) {
     *      console.log(error);
     * }
     * ```
