...
class OurConfig {
    constructor() {
        /**
         * The amount of decimal places your coin has, e.g. BytechCoin has two
         * decimals
         */
        this.decimalPlaces = 2;
        /**
         * The address prefix your coin uses - you can find this in CryptoNoteConfig.h.
         * In BytechCoin, this converts to bYTC
         */
        this.addressPrefix = 0x31c1ce;
        /**
        ...
        /**
         * Your coins 'ticker', generally used to refer to the coin, i.e. 123 BYTC
         */
        this.ticker = 'BYTC';
        /**
