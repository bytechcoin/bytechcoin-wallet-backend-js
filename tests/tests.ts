...
(async () => {
    ...
    /* Setup a daemon */
    const daemon: BlockchainCacheApi = new BlockchainCacheApi('blockapi.bytechpay.io');
    ...
    if (doPerformanceTests) {
        ...
        await tester.test(async () => {
            ...
            const daemon2: BlockchainCacheApi = new BlockchainCacheApi('blockapi.bytechpay.io');
